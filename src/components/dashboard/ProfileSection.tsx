      ...
      <div className="relative mt-5 mb-10">
        ...
        <div className="relative flex flex-col sm:flex-row items-center sm:items-start gap-6">
          ...
          <div className="relative group">
            ...
            <div className="relative h-40 w-40 sm:h-40 sm:w-40  lg:w-50 lg:h-50 rounded-full overflow-hidden border-4 border-cyan-400">
              {avatarUrl ? (
                <Image
                  src={avatarUrl}
                  alt={displayName}
          ...
          {/* Profile Info */}
          <div className="flex-1 ml-3 lg:ml-5 text-center mt-3 lg:mt-8 sm:text-left">
            <p className="text-xs sm:text-sm font-medium text-zinc-400 uppercase tracking-wider mb-2">
             View Profile
            </p>
            <h1 className="text-2xl sm:text-2xl md:text-5xl font-black mb-3 text-white font-bold"> Welcome, {displayName} </h1>
            {email && (
              <p className="text-sm sm:text-base text-cyan-400 mb-4">{email}</p>
            )}
