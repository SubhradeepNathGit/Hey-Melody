...
export default function Page() {
  ...
  return (
    <div className="fixed inset-0 w-full h-full overflow-hidden flex items-center justify-center bg-black">
      ...
      {/* Main card */}
      <div className="relative w-full max-w-[440px] px-4 -mt-10">
        <div
        ...
        >
          ...
          <div className="relative z-10">
            ...
            <div className="text-zinc-400 text-center mt-4 text-sm">
              ...
              <Link
                href="/login"
                className="font-bold text-cyan-400 hover:text-cyan-300 transition-colors decoration-transparent hover:decoration-cyan-400"
              >
                Log in
              </Link>
            </div>
